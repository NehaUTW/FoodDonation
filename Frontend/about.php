    ...
    <div class="container py-lg-5 py-md-3">
        <div class="row">
            <div class="col-lg-6">
                ...
                <p class="mt-3">Child poverty refers to the state of children living in poverty and applies to children from poor families or orphans being raised with limited or—in some cases—absent state resources. Children that fail to meet the minimum acceptable standard of the nation where that child lives are said to be poor.</p>
                ...
                <a href="about.php" class="btn btn-primary btn-style mt-lg-5 mt-4">Learn More about Us</a>
            </div>
         ...
         <div class="container">
             <div class="row align-items-center">
                 ...
                 <div class="main-midd-2 col-lg-3 mt-lg-0 mt-4 text-lg-right">
                     <a class="btn btn-style btn-primary" href="ourworks.php"><span class="fa fa-heart mr-1"></span> Donate
                         Now </a>
                 </div>
             </div>
             ...
             <div class="donar-img mt-5">
                <div class="right-side text-center">
                    ...
                    <a class="btn btn-text" href="ourworks.php">View More</a>
                </div>
            </div>
         </div>
     </div>
